...
<html>
    ...
    <body>
        ...
        <?php
            ...
            if (!$resultado) {
                ...
                foreach($resultado as $registro) {
                    ...
                    echo "<td>";
                    $destino="formulario_editar_software.php?id=".$registro['id']; //monta una cada y va generar un id distinto por cada registro
        ...
        ?>
        <div>
            <a href="formulario_nuevo_software.php">Nuevo Software</a>
        </div>
    </body>
</html>